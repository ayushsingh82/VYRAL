...
/// @title VyralToken
/// @notice The VYR ERC20 token used as collateral and quote currency for VYRAL markets.
/// @dev Anyone may call mint(). This is intentional for local/test deployments so the
///      UI can offer a "Get Test VYR" faucet button. Replace with restricted minting
///      (e.g. role-gated bridge or vesting) before any mainnet deployment.
contract VyralToken is ERC20, Ownable {
